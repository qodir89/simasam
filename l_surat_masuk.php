...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $b->perihal."<br><b>File : </b><i><a href='".base_URL()."upload/surat_masuk/".$b->file."'>".$b->file."</a>"?></td>
			<td><?php echo $b->dari; ?></td>
			<td><?php echo $b->no_surat."<br><i>Diterima: ".tgl_jam_sql($b->tgl_diterima)."</i>"?></td>
			<td class="ctr">
				<?php  
