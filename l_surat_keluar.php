...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $b->isi_surat."<br><b>File : </b><i><a href='".base_URL()."upload/surat_keluar/".$b->file."' target='_blank'>".$b->file."</a>"?></td>
			<td><?=getnamabagian($b->dari)?></td>
			<td><?php echo $b->tujuan?></td>
			<td><?php echo $b->no_surat."<br><i>Tgl.Surat: ".tgl_jam_sql($b->tgl_surat)."</i>"?></td>
			<td class="ctr">
				<?php  
