...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Penerima</td><td><b><input type="text" name="kpd_yth" autofocus tabindex="1" required value="<?php echo $kpd_yth; ?>" style="width: 400px" class="form-control"></b></td></tr>
