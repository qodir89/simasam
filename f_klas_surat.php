...
<form action="<?php echo base_URL(); ?>index.php/admin/klas_surat/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<tr><td width="10%">kode</td><td><b><input type="text" name="kode" required value="<?php echo $kode; ?>" style="width: 100px" class="form-control" autofocus></b></td></tr>
	...
	<tr><td width="20%">Deskripsi Kode</td><td><b><textarea name="uraian" required style="width: 700px; height: 100px" class="form-control"><?php echo $uraian; ?></textarea></b></td></tr>		
	<tr><td colspan="2">
