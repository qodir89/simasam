...
<table>
	...
	<tr><td width="25%"><b>Indeks Berkas</b></td><td width="50%">: </td><td><b>Kode : </b></td></tr>
	...
	<tr><td style="height: 60px" valign="top"><b>Isi Ringkasan</b></td><td valign="top" colspan="2">: <?php echo $datpil1->perihal; ?></td></tr>
	...
	if (!empty($datpil3)) {
		foreach ($datpil3 as $d3) {
			echo "<li><b><i>".$d3->isi_disposisi."</i></b>.<br> Batas : ".tgl_jam_sql($d3->batas_waktu).", Sifat: ".$d3->sifat." </br></li>";
		}
	}
	?>
	</ol>
