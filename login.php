  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <center><span class="navbar-brand"><strong style="font-family: verdana">DIGITAL ARSIP <?php echo $q_instansi->nama; ?></strong></span>
	...
	<div class="container-fluid" style="margin-top: 30px">
      ...
      <div class="row-fluid">
		...
		<center><legend>Login Admin</legend>	
		...
		<table align="center" style="margin-bottom: 0" class="table-form" width="90%">
			...
			<tr><td></td><td><input type="submit" class="btn btn-success" value="Masuk"></td></tr>
		</table>
	...
	<center style="margin-top: -15px;">&copy; 2015; <a href="">Divisi IT</a> | 
	<a href="https://wahidunana.wordpress.com/">Kang Raju</a><br>
	</center>
